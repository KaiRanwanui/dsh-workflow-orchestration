...
> 迭代计划：`plan/phases/phase-1-core/development-plan.md`（Iter-8）
...
| `PoC/legacy-root/workflows/demo-concurrent.yaml` | 新增并发 demo 工作流 |
...
| 文件 | 说明 |
|------|------|
| `plan/phases/phase-1-core/development-plan.md` | Iter-8 迭代计划 |
| `plan/phases/phase-1-core/iterations/iter7-report.md` | Iter-7（并发引擎） |
| `PoC/legacy-root/workflows/demo-concurrent.yaml` | Iter-8 并发 demo |
