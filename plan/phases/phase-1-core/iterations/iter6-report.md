...
> 迭代计划：`plan/phases/phase-1-core/development-plan.md`（Iter-6）
...
| 文件 | 说明 |
|------|------|
| `plan/phases/phase-1-core/development-plan.md` | Iter-6 迭代计划 |
| `plan/phases/phase-1-core/iterations/iter5-report.md` | Iter-5（架构调整，Iter-6 的前置） |
