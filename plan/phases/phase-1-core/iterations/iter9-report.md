...
> 迭代计划：`plan/phases/phase-1-core/development-plan.md`（Iter-9）
> 技术方案：`plan/design/multi-instance-session-design.md`
> 探针原始数据：`plan/phases/phase-1-core/iterations/iter9-probe-results.json`
...
| `plan/phases/phase-1-core/development-plan.md` | Iter-9 计划 → Iter-10 范围修正 |
| `plan/phases/phase-1-core/iterations/iter9-probe-results.json` | 探针原始数据 |
