...
> 迭代计划：`plan/phases/phase-1-core/development-plan.md`（Iter-10）
> 技术方案：`plan/design/multi-instance-session-design.md`
> 前置：`plan/phases/phase-1-core/iterations/iter9-report.md`（DSH Session 探针）
...
| `plan/phases/phase-1-core/iterations/iter9-report.md` | Iter-9 探针（目录约束与生命周期依据） |
| `plan/phases/phase-1-core/development-plan.md` | Iter-10 计划 → Iter-11 |
