...
> 本文件同时留档于仓库（`workflow-agent/plan/phases/phase-2-dsh-migration/iterations/`），权威细节以迁移计划文档为准。
...
**第一步必做**：通读 `plan/phases/phase-2-dsh-migration/iterations/dsh-0.1.5-rc-upgrade-impact-and-migration-plan.md`——破坏性变更、§3.3 七项迁移映射（before/after 代码）、四阶段计划全在里面。
