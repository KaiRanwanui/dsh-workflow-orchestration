...
// ---- module: workflow-parser (shared/workflow-parser.js) ----
// ============================================================================
...
// ---- module: workflow-paths (shared/workflow-paths.js) ----
// ============================================================================
...
// ---- module: workflow-validate (shared/workflow-validate.js) ----
// ============================================================================
...
// ---- module: workflow-edit (shared/workflow-edit.js) ----
// ============================================================================
...
// ---- module: zip-writer (shared/zip-writer.js) ----
// ============================================================================
...
// ---- module: items-extract (shared/items-extract.js) ----
// ============================================================================
...
// ---- module: engine (plugins/workflow-host/engine.js) ----
// ============================================================================
...
// ---- module: storage (plugins/workflow-host/storage.js) ----
// ============================================================================
...
// ---- module: instance-store (plugins/workflow-host/instance-store.js) ----
// ============================================================================
...
// ---- module: builtin-skills (plugins/workflow-host/builtin-skills.js) ----
// ============================================================================
...
// ---- module: tools-preset (plugins/workflow-host-preset/tools-preset.js) ----
// ============================================================================
...
// ---- module: webserver-routes (plugins/workflow-host/webserver-routes.js) ----
// ============================================================================
...
const BUILTIN_TEMPLATES = [
  ...
  {
    name: 'runtime-items-demo',
    description: 'Iter-26R 运行时 items 展开演示：上游 collect 写清单 → 下游 loop 按清单展开（items 文件启动时不存在，运行期延迟展开）',
    yaml: [
      '# Iter-26R 运行时 items 展开演示',
      '# 场景：上游 collect 任务写模块清单到 output/modules.txt，下游 loop 任务按清单展开为 N 个迭代',
      '# 启动时 output/modules.txt 不存在 → analyze 显示为占位组框（虚线琥珀色"⏳ 等待 items..."）',
      '# collect 完成后 → Host 自动读取 items 文件 → 占位展开为 3 个迭代 → 逐个执行 → 全部完成',
      '# 验收要点：面板观察占位组框→展开→迭代执行→下游放行',
      'name: runtime-items-demo',
      'version: "1.0"',
      'description: "Iter-26R 运行时 items 展开：collect→loop 延迟展开"',
      'tasks:',
      '  - id: collect',
      '    name: "收集模块清单"',
      '    processor: skills/list-collector/SKILL.md',
      '    outputs:',
      '      - output/modules.txt',
      '',
      '  - id: analyze',
